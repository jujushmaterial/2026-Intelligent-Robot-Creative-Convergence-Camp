...
```mermaid
flowchart LR
    A[Learn<br/>디자인씽킹 학습] --> B[Plan<br/>사전 인터뷰 계획]
    B --> C[Explore<br/>장호원 현장조사]
    C --> D[Adapt<br/>현장 상황에 따라 조사 변경]
    D --> E[Empathize<br/>주민 인터뷰와 직접 관찰]
    E --> F[Reframe<br/>문제 방향 수정]
    F --> G[Define<br/>페르소나와 POV]
    G --> H[Ideate<br/>철통이 아이디어 도출]
    H --> I[Prototype<br/>제품 시안과 시뮬레이션]
    I --> J[Present<br/>최종 발표와 Q&A]
    J --> K[Award<br/>은상 · 3위]
```
